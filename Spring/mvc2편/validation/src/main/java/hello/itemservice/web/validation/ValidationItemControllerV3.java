...
//    @PostMapping("/{itemId}/edit")
    public String editV1(@Validated @ModelAttribute Item item,BindingResult bindingResult,@PathVariable Long itemId) {
    ...
    @PostMapping("/{itemId}/edit")
    public String editV2(@Validated(value = UpdateCheck.class) @ModelAttribute Item item, BindingResult bindingResult, @PathVariable Long itemId) {
